...
//				+
                ...
                // NOTE: js 中包含 % 字符的时候，WebView.loadUrl() 工作不正常
                // https://code.google.com/p/android/issues/detail?id=69969
                (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT ? F_UEX_SECURE.replace("%", "%25") : F_UEX_SECURE);
